...
mobile browser experience. Includes 18,956 deduplicated presets: 374 from the four
butterchurn preset packs, 14,672 mainline lazy-loaded presets from the
...
collection, and 3,910 experimental NestDrop presets; the latter two
...
`src/presets-extra/` holds 14,672 mainline index names from
...
The mainline index contains 14,672 unique presets. If the folder is
missing, the app silently falls back to the 374 vendored presets.

The experimental NestDrop import adds 3,910 `[EXP] ` presets in 377 physical
...
374 vendored presets and 14,672 mainline presets, the current total is 18,956.
