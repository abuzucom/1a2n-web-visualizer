...
mobile browser experience. Includes 18,678 deduplicated presets: 374 from the four
butterchurn preset packs, 14,586 mainline lazy-loaded presets from the
...
collection, and 3,718 experimental NestDrop presets; the latter two
...
`src/presets-extra/` holds 14,586 mainline index names from
...
The mainline index contains 14,586 unique presets. If the folder is
missing, the app silently falls back to the 374 vendored presets.

The experimental NestDrop import adds 3,718 `[EXP] ` presets in 377 physical
...
374 vendored presets and 14,586 mainline presets, the current total is 18,678.
