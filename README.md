...
mobile browser experience. Includes 34,414 deduplicated presets: 374 from the four
butterchurn preset packs, 18,772 mainline lazy-loaded presets from the
...
collection, and 15,268 experimental NestDrop presets; the latter two
...
`src/presets-extra/` holds 18,772 mainline index names from
...
The mainline index contains 18,772 unique presets. If the folder is
missing, the app silently falls back to the 374 vendored presets.

The experimental NestDrop import adds 15,268 `[EXP] ` presets in 377 physical
...
374 vendored presets and 18,772 mainline presets, the current total is 34,414.
