...
browser. Includes 60,627 deduplicated presets: 376 from the four
butterchurn preset packs, 21,261 mainline lazy-loaded presets from the
...
collection, and 38,990 experimental NestDrop presets; the latter two
...
`src/presets-extra/` holds 21,261 mainline index names from
...
The mainline index contains 21,261 unique presets. If the folder is
missing, the app silently falls back to the 376 vendored presets.

The experimental NestDrop import adds 38,990 `[EXP] ` presets in 377 physical
...
376 vendored presets and 21,261 mainline presets, the current total is 60,627.
