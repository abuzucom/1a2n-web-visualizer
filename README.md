...
browser. Includes 57,318 deduplicated presets: 374 from the four
butterchurn preset packs, 20,604 mainline lazy-loaded presets from the
...
collection, and 36,340 experimental NestDrop presets; the latter two
...
|   +-- presets-extra/           # ~57k lazy-loaded presets (generated, committed)
...
`src/presets-extra/` holds 20,604 mainline index names from
...
The mainline index contains 20,604 unique presets. If the folder is
missing, the app silently falls back to the 374 vendored presets.

The experimental NestDrop import adds 36,340 `[EXP] ` presets in 377 physical
...
374 vendored presets and 20,604 mainline presets, the current total is 57,318.
