...
browser. Includes 40,734 deduplicated presets: 374 from the four
butterchurn preset packs, 20,556 mainline lazy-loaded presets from the
...
collection, and 19,804 experimental NestDrop presets; the latter two
...
|   +-- presets-extra/           # ~40k lazy-loaded presets (generated, committed)
...
`src/presets-extra/` holds 20,556 mainline index names from
...
The mainline index contains 20,556 unique presets. If the folder is
missing, the app silently falls back to the 374 vendored presets.

The experimental NestDrop import adds 19,804 `[EXP] ` presets in 377 physical
...
374 vendored presets and 20,556 mainline presets, the current total is 40,734.
