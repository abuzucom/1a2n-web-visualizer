...
browser. Includes 57,333 deduplicated presets: 376 from the four
butterchurn preset packs, 20,572 mainline lazy-loaded presets from the
...
collection, and 36,385 experimental NestDrop presets; the latter two
...
|   +-- presets-extra/           # ~60k lazy-loaded presets (generated, committed)
...
`src/presets-extra/` holds 20,572 mainline index names from
...
The mainline index contains 20,572 unique presets. If the folder is
missing, the app silently falls back to the 376 vendored presets.

The experimental NestDrop import adds 36,385 `[EXP] ` presets in 377 physical
...
376 vendored presets and 20,572 mainline presets, the current total is 57,333.
